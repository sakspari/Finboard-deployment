...
export function Header() {
  ...
  return (
    ...
    >
      <div className="glass-shell max-w-[1320px] mx-auto flex items-center justify-between rounded-[28px] px-5 md:px-7 h-16 text-text-primary">
        <div>
          <h1 className="font-[family-name:var(--font-display)] text-[1.35rem] md:text-[1.65rem] font-semibold tracking-[-0.045em]">
            Finboard
          </h1>
          <p className="text-[10px] md:text-[11px] text-text-secondary tracking-[0.24em] uppercase font-medium">
          ...
          <div className="flex items-center gap-2">
            ...
            {correctionCount > 0 && (
              <motion.button
                ...
                className="glass-button rounded-full px-3 py-2 text-sm font-medium text-text-secondary transition-all flex items-center gap-1.5"
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.985 }}
              onClick={reset}
              className="glass-button rounded-full px-4 py-2 text-sm font-medium text-text-primary transition-all"
            >
              Upload new file
            </motion.button>
          </div>
